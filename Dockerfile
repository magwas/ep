...
RUN apt -y install apache2 php php-mysql mysql-server wget less vim git php-dom
...
RUN service mysql start;bin/install-wp-tests.sh test_database root password
